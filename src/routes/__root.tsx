...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "PPTQ Nurul Huda" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          address: {
            "@type": "PostalAddress",
            streetAddress: "Jl. Raden Fatah No. 27, Sukamaju",
            addressLocality: "Cileungsi, Kabupaten Bogor",
            addressRegion: "Jawa Barat",
            postalCode: "16820",
            addressCountry: "ID",
          },
          telephone: "+62 21 8790 1234",
